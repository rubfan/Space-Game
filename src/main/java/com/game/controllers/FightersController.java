...
import com.game.model.dao.FightersDAO;
...
public class FightersController extends HttpServlet {
    FightersDAO fightersDAO = new FightersDAO();
    List<FighterEntity> date;
    String title;

    public void getDate(FightersDAO fightersDAO) throws SQLException {
        fightersDAO.createJDBCDateInformation("jdbc:mysql://localhost:3306/basebase", "root", "root");
        date = fightersDAO.getFighterList();
    }
