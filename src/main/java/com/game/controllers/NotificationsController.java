...
import com.game.model.dao.NotificationDAO;
...
public class NotificationsController extends HttpServlet {
    ...
    List<NotificationEntity> date;
    String title;

    public void getDate(NotificationDAO notificationDAO) throws SQLException {
        notificationDAO.createJDBCDateInformation("jdbc:mysql://localhost:3306/basebase", "root", "root");
        date = notificationDAO.getNotificationList();
    }
