...
public class BaysController extends HttpServlet {
    BaysDAO baysDAO = new BaysDAO();
    List<BayEntity> date;
    String title;

    public void getDate(BaysDAO baysDAO) throws SQLException {
        baysDAO.createJDBCDateInformation("jdbc:mysql://localhost:3306/basebase", "root", "root");
        date = baysDAO.getBayList();
    }
